...
pub mod wallet_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = "Please use CreateTransaction2 instead of this function."]
        ...
        #[doc = "Use this function instead of CreateTransaction."]
        ...
        #[doc = "Please use UpdateAccount2 instead of this function."]
        ...
        #[doc = "Use this function instead of UpdateAccount."]
        ...
        #[doc = "Please use VoteWitnessAccount2 instead of this function."]
        ...
        #[doc = "modify the consume_user_resource_percent"]
        ...
        #[doc = "Use this function instead of VoteWitnessAccount."]
        ...
        #[doc = "Please use CreateAssetIssue2 instead of this function."]
        ...
        #[doc = "Use this function instead of CreateAssetIssue."]
        ...
        #[doc = "Please use UpdateWitness2 instead of this function."]
        ...
        #[doc = "Use this function instead of UpdateWitness."]
        ...
        #[doc = "Please use CreateAccount2 instead of this function."]
        ...
        #[doc = "Use this function instead of CreateAccount."]
        ...
        #[doc = "Please use CreateWitness2 instead of this function."]
        ...
        #[doc = "Use this function instead of CreateWitness."]
        ...
        #[doc = "Please use TransferAsset2 instead of this function."]
        ...
        #[doc = "Use this function instead of TransferAsset."]
        ...
        #[doc = "Please use ParticipateAssetIssue2 instead of this function."]
        ...
        #[doc = "Use this function instead of ParticipateAssetIssue."]
        ...
        #[doc = "Please use FreezeBalance2 instead of this function."]
        ...
        #[doc = "Use this function instead of FreezeBalance."]
        ...
        #[doc = "Please use UnfreezeBalance2 instead of this function."]
        ...
        #[doc = "Use this function instead of UnfreezeBalance."]
        ...
        #[doc = "Please use UnfreezeAsset2 instead of this function."]
        ...
        #[doc = "Use this function instead of UnfreezeAsset."]
        ...
        #[doc = "Please use WithdrawBalance2 instead of this function."]
        ...
        #[doc = "Use this function instead of WithdrawBalance."]
        ...
        #[doc = "Please use UpdateAsset2 instead of this function."]
        ...
        #[doc = "Use this function instead of UpdateAsset."]
        ...
        #[doc = "Please use GetNowBlock2 instead of this function."]
        ...
        #[doc = "Use this function instead of GetNowBlock."]
        ...
        #[doc = "Please use GetBlockByNum2 instead of this function."]
        ...
        #[doc = "Use this function instead of GetBlockByNum."]
        ...
        #[doc = "Please use GetBlockByLimitNext2 instead of this function."]
        ...
        #[doc = "Use this function instead of GetBlockByLimitNext."]
        ...
        #[doc = "Please use GetBlockByLatestNum2 instead of this function."]
        ...
        #[doc = "Use this function instead of GetBlockByLatestNum."]
        ...
        pub async fn get_delegated_resource_account_index(
            &mut self,
            request: impl tonic::IntoRequest<super::BytesMessage>,
        ) -> Result<tonic::Response<super::DelegatedResourceAccountIndex>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = "Warning: do not invoke this interface provided by others."]
        #[doc = "Please use GetTransactionSign2 instead of this function."]
        pub async fn get_transaction_sign(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/protocol.Wallet/GetTransactionSign");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = "Warning: do not invoke this interface provided by others."]
        #[doc = "Use this function instead of GetTransactionSign."]
        pub async fn get_transaction_sign2(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/protocol.Wallet/GetTransactionSign2");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = "Warning: do not invoke this interface provided by others."]
        pub async fn create_address(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/protocol.Wallet/CreateAddress");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = "Warning: do not invoke this interface provided by others."]
        pub async fn easy_transfer_asset(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/protocol.Wallet/EasyTransferAsset");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = "Warning: do not invoke this interface provided by others."]
        pub async fn easy_transfer_asset_by_private(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/protocol.Wallet/EasyTransferAssetByPrivate");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = "Warning: do not invoke this interface provided by others."]
        pub async fn easy_transfer(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/protocol.Wallet/EasyTransfer");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = "Warning: do not invoke this interface provided by others."]
        pub async fn easy_transfer_by_private(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/protocol.Wallet/EasyTransferByPrivate");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = "Warning: do not invoke this interface provided by others."]
        pub async fn generate_address(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/protocol.Wallet/GenerateAddress");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        ) -> Result<tonic::Response<super::IncrementalMerkleVoucherInfo>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod wallet_solidity_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn generate_address(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/protocol.WalletSolidity/GenerateAddress");
            self.inner.unary(request.into_request(), path, codec).await
        }
        pub async fn get_merkle_tree_voucher_info(
            &mut self,
    ...
    impl<T: Clone> Clone for WalletSolidityClient<T> {
        fn clone(&self) -> Self {
            Self {
                inner: self.inner.clone(),
            }
    ...
    impl<T> std::fmt::Debug for WalletSolidityClient<T> {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(f, "WalletSolidityClient {{ ... }}")
        }
    }
}
#[doc = r" Generated client implementations."]
pub mod wallet_extension_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = "Please use GetTransactionsFromThis2 instead of this function."]
        ...
        #[doc = "Use this function instead of GetTransactionsFromThis."]
        ...
        #[doc = "Please use GetTransactionsToThis2 instead of this function."]
        ...
        #[doc = "Use this function instead of GetTransactionsToThis."]
    ...
    impl<T: Clone> Clone for WalletExtensionClient<T> {
        fn clone(&self) -> Self {
            Self {
                inner: self.inner.clone(),
            }
    ...
    impl<T> std::fmt::Debug for WalletExtensionClient<T> {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(f, "WalletExtensionClient {{ ... }}")
        }
    }
}
#[doc = r" Generated client implementations."]
pub mod database_client {
    ...
    impl<T: Clone> Clone for DatabaseClient<T> {
        fn clone(&self) -> Self {
            Self {
                inner: self.inner.clone(),
            }
    ...
    impl<T> std::fmt::Debug for DatabaseClient<T> {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(f, "DatabaseClient {{ ... }}")
        }
    }
}
#[doc = r" Generated client implementations."]
pub mod monitor_client {
    ...
    impl<T> std::fmt::Debug for MonitorClient<T> {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(f, "MonitorClient {{ ... }}")
        }
    }
}
#[doc = r" Generated client implementations."]
pub mod network_client {
    #![allow(unused_variables, dead_code, missing_docs)]
    use tonic::codegen::*;
    #[doc = " the api of tron's network such as node list."]
